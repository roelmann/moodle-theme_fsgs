...
FsGs is a child theme for Moodle's core theme Boost.
...
These settings below are found in the Moodle Site Administration Pages.  These are not related to the theme but will help bring out the best of FsGs.  
...
FsGs is a child theme of Boost.  
This means when Moodle updates the core Boost theme those changes will be applied to FsGs as well in most cases.

# Install from Github
Click on the button to "Clone or Download" https://github.com/dbnschools/moodle-theme_fsgs . When downloaded to your computer, unzip it. It should create a folder named "moodle-theme_fsgs-master". Rename the folder so that it is "fsgs" (without quotes). You can FTP that folder to your moodle site in /moodle/theme/ directory. Or you can create a new ZIP file of the "fsgs" folder and upload and install it via the Plugin Administration in Site Administration. 

## FsGs Moodle 33 1.5.8
* Fixed issue where site uses custom roles to define teacher and non-editing teacher roles.  This caused FsGs to not identify the teacher role to display contact information to the student in the student "This Course" panel. This caused FsGs to display all users of the course as teachers.  This fix will show no users as teachers.  In file classes/output/core_renderer.php you can find code comments on where you should change the teacher and non-editing teacher shortnames to match your customized roles around lines 775 and 797.

## FsGs Moodle 33 1.5.7
...
## FsGs Moodle 33 1.5.3 2017062200
...
* Fixed issue when courseoverviewfileslimit is 0.  https://github.com/dbnschools/moodle-theme_fsgs/issues/4

## FsGs Moodle 33 1.5.2 2017062000 Design and Style
...
## FsGs Moodle 33 1.5.1 2017060700 bug fixes
...
* Added dropdown setting for Activity Icon size in FsGs > Content Areas.  default 36px.
* Updated elearner and default_x style presets.

## FsGs Moodle 33 1.5.0 2017051900
...
## FsGs Moodle 33 1.4.9 2017051900
...
## FsGs Moodle 33 1.4.8 2017051800
...
## FsGs Moodle 33 1.4.7 2017051700
...
* Added frontpage custom login form just in case you do not force users to login.  This was sorely lacking in FsGs.
...
## FsGs Moodle 33 1.4.6 2017051600
...
* Changed some default settings for a better experience when first installing FsGs.
...
## FsGs Moodle 33 1.4.5 2017051200
...
## FsGs 1.4.1
* Added Block Column width to control block widths in FsGs Content Areas page
...
* Custom Logo upload for FsGs only appears on homepage above new slideshow so that once in a course the student is focused on content
...
## FsGs 1.4.0
* Major changes to layout!  This is a major change in direction for the FsGs theme.
...
## FsGs 1.2.9
* Fixed Moodle 3.2.1+ changes to Boost theme that impact FsGs.  Issue related to header elements breaking such as the This Course Dropdown.
...
## FsGs 1.2.6
* Added Frontpage Available courses box styling.  Setting in theme admin settings will allow Site admin to switch between default Moodle presentation of available courses and the new FsGs display which is a tiled display in a grid.  SPECIAL THANKS TO José Miguel Dager Montoya for helping get this feature started.
...
* Added Frontpage Available courses box styling.  Setting in theme admin settings will allow Site admin to switch between default Moodle presentation of available courses and the new FsGs display.  SPECIAL THANKS TO José Miguel Dager Montoya for helping get this feature started.
...
## FsGs v1.2.2  non published
* Style Presets have been refined for better control of colors and variables.  
* NEW Style Preset: Evolve-D.  This preset has many of the style elements of the Evolve-D theme for those users who might want to migrate from Evolve-D to FsGs.  Switching and upgrading will utilize the new features of Boost but have a similar look and feel of Evolve-D.
...
## FsGs v1.1.7
* Made This Course Menu customizable with the abilty to checkoff menu items in FsGs Theme Admin page.  

## FsGs v1.1.6
* Fixed activity edit menu had disappeared during a Boost update.  Fixed core renderer on FsGs.
...
* Moved SCSS to styles.scss so that FsGs will work with default presets and user uploaded presets.  This includes marketing tiles, navigation icons, and other custom elements added to FsGs.
