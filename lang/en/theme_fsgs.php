...
// Theme strings.
$string['choosereadme'] = 'FsGs provides a unique visual experience to the default Boost theme with customization features such as color choosers and enhanced homepage experience.';
$string['configtitle'] = 'FsGs';
$string['pluginname'] = 'FsGs';
...
$string['generalcontentinfodesc'] = 'The options below help you customize the way content is displayed and turn on additional features for FsGs.';
...
$string['blockwidthfsgs'] = 'Block Column Width';
$string['blockwidthfsgs_desc'] = 'Adjust the width of the block column.';
