...
namespace theme_fsgs\output\core;
...
if (theme_fsgs_get_setting('enablefrontpageavailablecoursebox')) {
class course_renderer extends \theme_boost\output\core\course_renderer {
    	...
    	if (count($rcourseids) > 0) {
    		foreach ($acourseids as $courseids) {
    			...
    			foreach ($courseids as $courseid) {
                    ...
                    $trimtitle = theme_fsgs_course_trim_char($course->fullname, $trimtitlevalue);

                    $summary = theme_fsgs_strip_html_tags($course->summary);
                    $summary = theme_fsgs_course_trim_char($summary, $trimsummaryvalue);
                ...
                $enrollbutton = get_string('enrollcoursecard' , 'theme_fsgs');
                   $rowcontent .= '
                    <div class="col-md-4">
                        ';
                    $rowcontent .= '
    ...
    protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
        if (!theme_fsgs_get_setting('enablecategoryicon')) {
        ...
        // LOAD ICON
        $val = theme_fsgs_get_setting('catsicon');
    ...
    public function course_modchooser($modules, $course) {
        ...
        $modchooser = new \theme_fsgs\output\modchooser($course, $modules);
