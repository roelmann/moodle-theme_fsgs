...
$THEME->scss = function($theme) {
    return theme_fsgs_get_main_scss_content($theme);
};
...
$THEME->csstreepostprocessor = 'theme_fsgs_css_tree_post_processor';
$THEME->prescsscallback = 'theme_fsgs_get_pre_scss';
$THEME->extrascsscallback = 'theme_fsgs_get_extra_scss';
