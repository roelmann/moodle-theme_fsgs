...
// Preset.
$name = 'theme_fsgs/preset';
$title = get_string('preset', 'theme_fsgs');
$description = get_string('preset_desc', 'theme_fsgs');
$presetchoices[] = '';
...
$fs = get_file_storage();
$files = $fs->get_area_files($context->id, 'theme_fsgs', 'preset', 0, 'itemid, filepath, filename', false);
...
$name = 'theme_fsgs/presetfiles';
$title = get_string('presetfiles', 'theme_fsgs');
$description = get_string('presetfiles_desc', 'theme_fsgs');
