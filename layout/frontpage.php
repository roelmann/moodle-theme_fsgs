...
fsgs_boostnavigation_extend_navigation($PAGE->navigation);
fsgs_local_navigation_extend_navigation($PAGE->navigation);
...
$PAGE->requires->js('/theme/fsgs/javascript/scrolltotop.js');
}

$templatecontext['flatnavigation'] = $PAGE->flatnav;
echo $OUTPUT->render_from_template('theme_fsgs/frontpage', $templatecontext);