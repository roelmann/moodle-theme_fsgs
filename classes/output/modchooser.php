...
class modchooser extends chooser {
    ...
    public function __construct($course, $modules) {
        global $PAGE;
        // This copy of the modchooser is modified for Hillbrook Anglican School theme fsgs
        // It contains functionality to output a section of modules defined as "commonly used" in the theme_fsgs settings

        $this->course = $course;

        $sections = [];
        $context = context_course::instance($course->id);
        $showonlycustom = get_config('theme_fsgs', 'showonlycustomactivities');
        $showallmanager = get_config('theme_fsgs', 'showalltomanager');
        ...
        $commonlyused = array();
        $commonlyusedsetting = get_config('theme_fsgs', 'commonlyused');
        ...
        if (count($commonlyused)) {
            $sections[] = new chooser_section('commonlyused', new lang_string('modchoosercommonlyusedtitle', 'theme_fsgs', $PAGE->theme->settings->modchoosercustomlabel),
